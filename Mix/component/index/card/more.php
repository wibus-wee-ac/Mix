...
?>
<div class="assets news-item" style="opacity: 1; transform: translate(0px, 0px);animation: <?php $this->options->IndexAction(); ?>;">
                    ...
                    <div class="SectionNews_card-cover-wrap__1DHPb">
                     <div>
                      <div style="position: relative; max-width: 100%; margin: auto;">
                       ...
                       <img src="<?php echo thumb($this->cid, $GLOBALS['assetURL']); ?>" alt="photo" />
                       </div>
